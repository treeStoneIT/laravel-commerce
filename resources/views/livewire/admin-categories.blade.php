    ...
    <div class="flex">
        ...
        <div class="w-full flex items-center mb-6">
            ...
            <div class="flex-no-shrink ml-auto">
                <a href="{{ route('admin.category.create') }}" type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition ease-in-out duration-150 whitespace-no-wrap">
                    Add Category
                </a>
            </div>
        </div>
                ...
                <table class="min-w-full">
                    ...
                    @foreach ($categories as $category)
                        <tr class="{{ $loop->odd ? 'bg-white':'bg-gray-50'}}">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-900 max-w-sm">
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                <div class="inline-flex items-center text-gray-400">
                                    <div class="inline-flex">
                                        <a href="{{ route('admin.category.show',$category->id) }}" class="cursor-pointer hover:text-indigo-600 mr-3 inline-flex items-center">
                                    ...
                                    <div class="inline-flex">
                                        <a href="{{ route('admin.category.edit', $category->id) }}" class="cursor-pointer hover:text-indigo-600 mr-3 inline-flex items-center">
