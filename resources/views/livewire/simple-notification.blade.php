            ...
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-shrink-0 flex">
                        <button @click="@this.set('notificationOpen', 'false')" class="inline-flex text-gray-400 focus:outline-none focus:text-gray-500 transition ease-in-out duration-150">
