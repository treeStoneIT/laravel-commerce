<div class="relative bg-gray-50 md:overflow-hidden">
            ...
            <nav class="relative flex items-center justify-between sm:h-10 md:justify-end">
                <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                    <div class="flex items-center justify-between w-full md:w-auto">
                        <a href="/">
                            <img class="h-16 hidden sm:block"
                                 src="{{ asset('img/horizontal-butcher-logo-trimmed.png') }}" alt="" />
                            <img class="h-10 block sm:hidden"
                                 src="{{ asset('img/butcher-logo-icon.png') }}" alt="" />
                        </a>
                ...
                <div class="hidden md:block">
                    <a href="{{ route('categories') }}" class="font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Categories</a>
                    <a href="mailto:test@example.com" class="ml-10 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Contact Us</a>
                </div>
            </nav>
        </div>
            ...
            <div class="rounded-lg shadow-md">
                <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                    ...
                    <div class="px-2 pt-2 pb-3">
                        <a href="{{ route('categories') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out">Categories</a>
                        <a href="mailto:test@example.com" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
